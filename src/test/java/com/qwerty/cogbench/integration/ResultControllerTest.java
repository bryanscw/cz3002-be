  ...
  public void should_allowFetchAllResult_ifAuthorized() throws Exception {
    ...
    this.mockMvc.perform(
        ...
        .andExpect(status().isOk())
            ...
            .andExpect(jsonPath("$[0].createdDate", is(getPersistentResult().getCreatedDate())))
            .andExpect(jsonPath("$[0].lastModifiedBy", is(getPersistentResult().getLastModifiedBy())))
            .andExpect(jsonPath("$[0].lastModifiedDate", is(getPersistentResult().getLastModifiedDate())))
