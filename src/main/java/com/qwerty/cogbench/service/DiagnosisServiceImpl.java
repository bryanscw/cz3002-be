...
public class DiagnosisServiceImpl implements DiagnosisService{
    ...
    public DiagnosisServiceImpl(DiagnosisRepository diagnosisRepository, ResultRepository resultRepository, UserRepository userRepository){
    ...
    @Override
    public Diagnosis create(String userEmail, Integer resultId, Diagnosis diagnosis, Authentication authentication) {
        ...
        if (diagnosisRepository.findDiagnosisByResult(resultToFind).isPresent()){
            String errorMsg = String.format("Diagnosis for result with id [%s] already created.", resultId);
            log.error(errorMsg);
    ...
    @Override
    public Diagnosis update(String userEmail, Integer resultId, Diagnosis diagnosis, Authentication authentication) {
